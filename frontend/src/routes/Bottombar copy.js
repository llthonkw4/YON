...
const BottomBar = () => {
	...
	return (
		<>
			<div class="select-none h-66 pt-4 pr-4 w-full flex flex-row border-r border-gray-200 justify-center fixed bottom-0 dark:text-white z-10 bg-gray-500">
				<div class="flex flex-row justify-between">
					<div class="flex flex-row w-full ">
						...
						<div class="cursor-pointer w-auto flex flex-row items-center">
							<div class="p-3 rounded-full flex flex-row text-xl mb-2 hover:bg-gray-200 transition delay-50 duration-300">
